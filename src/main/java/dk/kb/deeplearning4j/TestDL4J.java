...
public class TestDL4J {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length < 1) {
            System.err.println("Missing trainpercentage. Exiting program");
            System.exit(1);
        }
        int trainpercentage = Integer.parseInt(args[0]);
        ...
        File parentDir = new File("/home/test/devel/", "small-corpus");
